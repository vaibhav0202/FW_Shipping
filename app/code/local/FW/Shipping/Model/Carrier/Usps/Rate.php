<?php
class FW_Shipping_Model_Carrier_Usps_Rate extends Mage_Usa_Model_Shipping_Carrier_Usps {
	protected $methodCode;

	//Override collectRates because using the core function won't run unless the USPS shipping method is enabled.	
	public function collectRates(Mage_Shipping_Model_Rate_Request $request)
    {
    	//These are all functions in the Mage_Usa_Model_Shipping_Carrier_Usps class.
